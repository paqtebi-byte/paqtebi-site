...
import { logoutAdmin, getRegisteredUsers } from '../services/authService';
            ...
            <div className="animate-fade-up">
              <div className="bg-white rounded-2xl overflow-hidden" style={{ border: '1px solid #e5e7eb' }}>
                <div className="flex items-center gap-3 px-6 py-4" style={{ borderBottom: '1px solid #f3f4f6' }}>
                  ...
                  <h3 className="font-bold text-gray-800">დარეგისტრირებული მომხმარებლები</h3>
                ...
                <table className="data-table">
                  <thead>
                    <tr>
                      <th>მომხმარებელი</th>
                      <th>ელ-ფოსტა</th>
                      <th style={{ textAlign: 'right' }}>სტატუსი</th>
                    </tr>
                  </thead>
                  <tbody>
                    {users.map((user, idx) => (
