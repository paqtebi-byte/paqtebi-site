          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <aside className="lg:col-span-4">
              <div id="sidebar-scroll" className="sticky top-24 max-h-[calc(100vh-6rem)] overflow-y-auto pr-2 pb-6 scroll-smooth custom-scrollbar">
                <Sidebar articles={articleOnlyItems} customArticles={sidebarArticles} videos={articles.filter((articleItem) => articleItem.contentType === 'video' || (articleItem.category && ['ვიდეო რეპორტაჟები', 'პოდკასტები', 'საინტერესო'].includes(articleItem.category)))} onArticleClick={handleArticleClick} />
              </div>
            </aside>
          </div>
        )}
